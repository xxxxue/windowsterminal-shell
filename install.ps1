    ...
    [bool]$isPreview)
{
    ...
    if ($layout -eq "Default") {
        ...
        if ($name -eq "PowerShell"){
            ...
            CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalAdmin_$guid" "Open $name" $profileIcon $elevated $true   
            ...
            CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalAdmin_$guid" "Open $name" $profileIcon $elevated $true   
        }
    ...
    [bool]$includePreview)
{
    ...
    if ($layout -eq "Default") {
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalAdmin' -Name 'MUIVerb' -PropertyType String -Value 'Windows Terminal' | Out-Null
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalAdmin' -Name 'MUIVerb' -PropertyType String -Value 'Windows Terminal' | Out-Null
